...
public class ArmstandPlatformDB {
    ...
    public ArmstandPlatformDB(){}

    public ArmstandPlatformDB(int id, int tenMeter, int sevenFiveMeter, int fiveMeter, String diveName,
